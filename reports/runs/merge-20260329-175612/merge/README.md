...
| --- | --- | --- |
| `manifest` | `reports/runs/merge-20260329-175612/merge/artifacts/merge-manifest.json` | `application/json` |
| `dataset_manifest` | `reports/runs/merge-20260329-175612/merge/artifacts/dataset-manifest.json` | `application/json` |
| `report` | `reports/runs/merge-20260329-175612/merge/artifacts/README.md` | `text/markdown` |
...
- Sample root: `reports/runs/merge-20260329-175612/merge/samples`
